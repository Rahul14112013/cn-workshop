...
== Java 9 
IMPORTANT: error - February 2018
JDK 9 has deprecated the java.xml.bind module which is to be removed, see: https://docs.oracle.com/javase/9/docs/api/java.xml.bind-summary.html

If you get a Class Not Found exception for JAXB `java.lang.ClassNotFoundException: javax.xml.bind.JAXBException` then in the Maven pom.xml add:
